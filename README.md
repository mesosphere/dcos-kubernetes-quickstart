...
To deploy a cluster with enabled [RBAC](https://docs.mesosphere.com/services/kubernetes/2.3.0-1.14.1/operations/authn-and-authz/#rbac) update `.deploy/options.json`:
