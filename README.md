...
Before proceeding, please check the [current package limitations](https://docs.mesosphere.com/service-docs/beta-kubernetes/0.3.0-1.7.11-beta/limitations/).

## Pre-Requisites

First, make sure your cluster fulfil the [Kubernetes package default requirements](https://docs.mesosphere.com/service-docs/beta-kubernetes/0.3.0-1.7.11-beta/install/#prerequisites/).
